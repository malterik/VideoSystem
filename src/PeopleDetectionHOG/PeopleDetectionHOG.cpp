#include "PeopleDetectionHOG.hpp"

PeopleDetectionHOG::PeopleDetectionHOG() {
    hog_.setSVMDetector(cv::HOGDescriptor::getDefaultPeopleDetector());	
}

void PeopleDetectionHOG::detectAndDisplay(cv::Mat image) {
    ...
    cv::imshow("PeopleDetectionHOG",image);
}
